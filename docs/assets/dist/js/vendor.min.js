...
"use strict";
eval("\n\nvar _dialog = __webpack_require__(/*! ./dialog */ \"./docs/assets/src/js/dialog.js\");\n\n$(function () {\n  fbdb.sync(function (comments) {\n    var $commentList = $(\"#commentList\").empty();\n    comments.forEach(function (commentObj) {\n      $commentList.prepend($(\"<dd class=\\\"comment_text\\\"><p>\" + commentObj.comment + \"</p></dd>\")).prepend($(\"\\n            <dt class=\\\"comment_title\\\" data-key='\" + commentObj.key + \"'>\\n              <span class='ctitle'>\" + commentObj.username + \"</span>\\n              <button class=\\\"comment-edit\\\">\\n                <i class='far fa-edit'>&nbsp;\\uC218\\uC815</i>\\n              </button>&nbsp;\\n              <button class=\\\"comment-delete\\\">\\n                <i class='far fa-trash-alt'>&nbsp;\\uC0AD\\uC81C</i>\\n              </button>\\n            </dt>\\n          \"));\n    });\n  });\n\n  $(\"#commentList\").on(\"click\", \".comment-edit\", function () {\n    $(\"#updateKey\").val((0, _dialog.getKeyFormDataProp)($(this)));\n    $(\"#updateUsername\").val((0, _dialog.getUsernameFromProp)($(this)));\n    $(\"#updateContent\").val((0, _dialog.getContentFromProp)($(this)));\n    _dialog.updateDialog.dialog(\"open\");\n  }).on(\"click\", \".comment-delete\", function () {\n    $(\"#deleteKey\").val((0, _dialog.getKeyFormDataProp)($(this)));\n    _dialog.deleteDialog.dialog(\"open\");\n  });\n\n  $(\"#messageForm\").submit(function (e) {\n    e.preventDefault();\n    var $username = $(\"#messageForm input[name=name]\");\n    var $password = $(\"#messageForm input[name=password]\");\n    var $message = $(\"#messageForm textarea[name=message]\");\n\n    var username = $username.val().trim();\n    var password = $password.val().trim();\n    var message = $message.val().trim();\n\n    if (!username || username.length < 2) {\n      alert(\"이름은 2글자 이상 입력해주세요.\");\n      $username.focus();\n      return;\n    }\n\n    if (!password || password.length < 4) {\n      alert(\"비밀번호는 4자 이상 입력해주세요.\");\n      $password.focus();\n      return;\n    }\n\n    if (!message || message.length < 4) {\n      alert(\"축하메세지는 4자 이상 입력해주세요.\");\n      $message.focus();\n      return;\n    }\n    var response = fbdb.write(username, password, message);\n\n    if (response.success) {\n      $username.val(\"\");\n      $password.val(\"\");\n      $message.val(\"\");\n    }\n  });\n});\n\n//# sourceURL=webpack:///./docs/assets/src/js/commentList.js?");
